...
const settings = {
    // ===COUNT & LIMIT=== //
    MAXIMUM_EMAIL_ADDRESSES_COUNT_PER_MBOX_FILE: 5000000, // Determine the maximum count of email addresses per MBOX file to scan.
    MAXIMUM_EMAIL_MESSAGES_COUNT_PER_MBOX_FILE: 1000000, // Determine the maximum count of messages per MBOX file to scan.
    MAXIMUM_LINES_COUNT_PER_MBOX_FILE: 100000000, // Determine the maximum counts of lines per MBOX file to scan.
    MINIMUM_FILE_SIZE_BYTES_PER_MBOX_FILE: 1024, // Determine the minimum size of MBOX file to scan in bytes.
    MAXIMUM_FILE_SIZE_BYTES_PER_MBOX_FILE: 10737418240, // Determine the maximum size of MBOX file to scan in bytes.
    EMAIL_ADDRESSES_CRAWL_LIMIT_COUNT: 100, // Determine the maximum number of email addresses per TXT file to in the crawl service.
    EMAIL_ADDRESSES_MERGE_LIMIT_COUNT: 100, // Determine the maximum number of email addresses per TXT file to in the merge service.
    MAXIMUM_MERGE_ROUNDS_COUNT: 10, // Determine the maximum number of merge rounds in the merge service.
    SECONDS_DELAY_BETWEEN_VALIDATIONS: 1, // Determine the number of seconds to delay between the validations in the validate service.
    MAXIMUM_EMAIL_CHARACTERS_LENGTH: 50, // Determine the maximum charecters count of email addresses.
    ADVANCE_MERGE_MULTIPLY: 2, // Determine the rate ot the merge in the merge service.

    // ===FILE NAME=== //
    DIST_TEMPORARY_FILE_NAME: 'temporary_crawl', // Determine the temporary name of the TXT file in the crawl service.
    DIST_FINAL_LIST_VIEW_FILE_NAME: 'final_list_view', // Determine the final name of the TXT file of all the email addresses in a list view (separated each lines).
    DIST_FINAL_MERGE_VIEW_FILE_NAME: 'final_merge_view', // Determine the final name of the TXT file of all the email addresses in a merge view (separated commas).
    DIST_FINAL_VALID_FILE_NAME: 'final_valid', // Determine the final name of the TXT file of all the valid email addresses stored in.
    DIST_FINAL_INVALID_FILE_NAME: 'final_invalid', // Determine the final name of the TXT file of all the invalid email addresses stored in.
    DIST_FINAL_SUMMARY_FILE_NAME: 'final_summary', // Determine the final name of the TXT file of all the summary details about the process stored in.
